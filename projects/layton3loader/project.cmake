# Layton3loader-specific build settings, included by the top-level CMakeLists.
#
...
if(EXISTS ${FFMPEG_MIN_DIR}/lib/libavcodec.a)
    ...
    # Built by projects/layton3loader/tools/build_ffmpeg_min.sh
    ...
    message(STATUS "Layton3loader: cutscenes via bundled static FFmpeg")
else()
    find_package(PkgConfig REQUIRED)
    pkg_check_modules(FFMPEG REQUIRED IMPORTED_TARGET
        libavcodec libavformat libavutil libswscale libswresample)
    target_link_libraries(${CMAKE_PROJECT_NAME} PRIVATE PkgConfig::FFMPEG)
    message(WARNING "Layton3loader: using the system FFmpeg, which needs many .so files on "
                    "the target. Run projects/layton3loader/tools/build_ffmpeg_min.sh "
