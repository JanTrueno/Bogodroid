# Laytonloader-specific build settings, included by the top-level CMakeLists.
#
...
if(EXISTS ${FFMPEG_MIN_DIR}/lib/libavcodec.a)
    ...
    # Built by projects/laytonloader/tools/build_ffmpeg_min.sh
    ...
    message(STATUS "Laytonloader: cutscenes via bundled static FFmpeg")
else()
    find_package(PkgConfig REQUIRED)
    pkg_check_modules(FFMPEG REQUIRED IMPORTED_TARGET
        libavcodec libavformat libavutil libswscale libswresample)
    target_link_libraries(${CMAKE_PROJECT_NAME} PRIVATE PkgConfig::FFMPEG)
    message(WARNING "Laytonloader: using the system FFmpeg, which needs many .so files on "
                    "the target. Run projects/laytonloader/tools/build_ffmpeg_min.sh "
