...
using namespace jnivm::com::Level5::LT2R;
...
{
    return std::make_shared<FakeJni::JString>("1.0.6");
}
...
// device_language()). Anything else -- including an unset config -- falls
// back to English, same as the Switch port's default case.
