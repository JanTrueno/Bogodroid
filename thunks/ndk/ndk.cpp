...
NO_THUNK("AAsset_getRemainingLength", (uintptr_t)&AAsset_getRemainingLength),
NO_THUNK("AAsset_getRemainingLength64", (uintptr_t)&AAsset_getRemainingLength64),
...
// Native input queue (thunks/ndk/ainput.c) -- ANativeActivity apps take input
// through this, not through JNI KeyEvent/MotionEvent objects.
NO_THUNK("AInputQueue_attachLooper", (uintptr_t)&AInputQueue_attachLooper),
NO_THUNK("AInputQueue_detachLooper", (uintptr_t)&AInputQueue_detachLooper),
NO_THUNK("AInputQueue_hasEvents", (uintptr_t)&AInputQueue_hasEvents),
NO_THUNK("AInputQueue_getEvent", (uintptr_t)&AInputQueue_getEvent),
NO_THUNK("AInputQueue_preDispatchEvent", (uintptr_t)&AInputQueue_preDispatchEvent),
NO_THUNK("AInputQueue_finishEvent", (uintptr_t)&AInputQueue_finishEvent),
NO_THUNK("AInputEvent_getType", (uintptr_t)&AInputEvent_getType),
NO_THUNK("AInputEvent_getDeviceId", (uintptr_t)&AInputEvent_getDeviceId),
NO_THUNK("AInputEvent_getSource", (uintptr_t)&AInputEvent_getSource),
NO_THUNK("AKeyEvent_getAction", (uintptr_t)&AKeyEvent_getAction),
NO_THUNK("AKeyEvent_getKeyCode", (uintptr_t)&AKeyEvent_getKeyCode),
NO_THUNK("AKeyEvent_getRepeatCount", (uintptr_t)&AKeyEvent_getRepeatCount),
NO_THUNK("AKeyEvent_getFlags", (uintptr_t)&AKeyEvent_getFlags),
NO_THUNK("AKeyEvent_getMetaState", (uintptr_t)&AKeyEvent_getMetaState),
NO_THUNK("AMotionEvent_getAction", (uintptr_t)&AMotionEvent_getAction),
NO_THUNK("AMotionEvent_getFlags", (uintptr_t)&AMotionEvent_getFlags),
NO_THUNK("AMotionEvent_getPointerCount", (uintptr_t)&AMotionEvent_getPointerCount),
NO_THUNK("AMotionEvent_getPointerId", (uintptr_t)&AMotionEvent_getPointerId),
NO_THUNK("AMotionEvent_getX", (uintptr_t)&AMotionEvent_getX),
NO_THUNK("AMotionEvent_getY", (uintptr_t)&AMotionEvent_getY),
NO_THUNK("AMotionEvent_getAxisValue", (uintptr_t)&AMotionEvent_getAxisValue),
    {NULL, (uintptr_t)NULL}};
